        ...
        <div class="bg-white dark:bg-slate-700 rounded-xl shadow-md dark:shadow-slate-900/50 overflow-hidden"
            ...
            <div class="flex flex-wrap border-b border-gray-200 dark:border-slate-600">
                ...
                <button @click="activeDay = 'day4'"
                        :class="{ 'border-tek-blue-700 dark:border-tek-blue-400 text-tek-blue-700 dark:text-tek-blue-400': activeDay === 'day4' }"
                        class="py-4 px-6 font-medium border-b-2 border-transparent hover:text-tek-blue-700 dark:hover:text-tek-blue-400 transition-colors">
                    Day 4: May 21
                </button>
                <button @click="activeDay = 'day5'"
                        :class="{ 'border-tek-blue-700 dark:border-tek-blue-400 text-tek-blue-700 dark:text-tek-blue-400': activeDay === 'day5' }"
                        class="py-4 px-6 font-medium border-b-2 border-transparent hover:text-tek-blue-700 dark:hover:text-tek-blue-400 transition-colors">
                    Day 5: May 22
                </button>
            </div>
            ...
            <div x-show="activeDay === 'day1'" class="p-6 space-y-6">
                <div class="border-l-4 border-tek-orange-700 dark:border-tek-orange-400 pl-4 py-2 mb-8">
                    ...
                    <p class="text-gray-600 dark:text-slate-300">Intensive hands-on workshops to level up your skills</p>
                </div>

                <div class="grid md:grid-cols-2 gap-6">
                    <div class="p-6 border border-gray-200 dark:border-slate-600 rounded-lg hover:shadow-md transition-shadow bg-white dark:bg-slate-600/50">
                        <div class="flex justify-between items-start mb-4">
                            ...
                            <span class="bg-tek-orange-100 dark:bg-tek-orange-800/20 text-tek-orange-800 dark:text-tek-orange-300 text-xs py-1 px-2 rounded">Workshop</span>
                        </div>
                        <p class="text-gray-600 dark:text-slate-300 text-sm mb-4">
                            Deep dive into Laravel's architecture patterns, service containers, and advanced dependency injection.
                        </p>
                        <div class="flex items-center">
                            <img src="https://randomuser.me/api/portraits/women/45.jpg" alt="Speaker" class="w-10 h-10 rounded-full mr-3">
                            <div>
                    ...
                    <div class="p-6 border border-gray-200 dark:border-slate-600 rounded-lg hover:shadow-md transition-shadow bg-white dark:bg-slate-600/50">
                        ...
                        <p class="text-gray-600 dark:text-slate-300 text-sm mb-4">
                            Hands-on security workshop covering OWASP Top 10, security best practices, and real-world examples.
                        </p>
                        <div class="flex items-center">
                            <img src="https://randomuser.me/api/portraits/women/68.jpg" alt="Speaker" class="w-10 h-10 rounded-full mr-3">
                            <div>
                    ...
                    <div class="p-6 border border-gray-200 dark:border-slate-600 rounded-lg hover:shadow-md transition-shadow bg-white dark:bg-slate-600/50">
                        ...
                        <p class="text-gray-600 dark:text-slate-300 text-sm mb-4">
                            Optimize PHP applications for maximum performance, from code-level optimizations to caching strategies.
                        </p>
                        <div class="flex items-center">
                            <img src="https://randomuser.me/api/portraits/men/32.jpg" alt="Speaker" class="w-10 h-10 rounded-full mr-3">
                            <div>
                    ...
                    <div class="p-6 border border-gray-200 dark:border-slate-600 rounded-lg hover:shadow-md transition-shadow bg-white dark:bg-slate-600/50">
                        ...
                        <div class="flex items-center">
                            <img src="https://randomuser.me/api/portraits/men/67.jpg" alt="Speaker" class="w-10 h-10 rounded-full mr-3">
                            <div>
            ...
            <div x-show="activeDay === 'day2'" class="p-6 space-y-6">
                <div class="border-l-4 border-tek-orange-700 dark:border-tek-orange-400 pl-4 py-2 mb-8">
                    ...
                    <p class="text-gray-600 dark:text-slate-300">Main conference tracks with keynotes and technical sessions</p>
                </div>
