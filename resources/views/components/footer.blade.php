                    ...
                    <a href="https://www.phptek.tv"
                       class="text-gray-600 dark:text-slate-300 hover:text-tek-blue-700 dark:hover:text-tek-blue-400 transition-colors">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                             ...
                             class="h-5 w-5">
                            <path
                                d="M20 6.5V5.25C20 4.56 19.44 4 18.75 4H5.25C4.56 4 4 4.56 4 5.25V6.5L5.5 3.5C5.65 3.19 5.96 3 6.3 3H6.4C6.74 3 7.05 3.19 7.2 3.5L8.5 6H15.5L16.8 3.5C16.95 3.19 17.26 3 17.6 3H17.7C18.04 3 18.35 3.19 18.5 3.5L20 6.5ZM5.25 7.5C4.56 7.5 4 8.06 4 8.75V18.25C4 18.94 4.56 19.5 5.25 19.5H18.75C19.44 19.5 20 18.94 20 18.25V8.75C20 8.06 19.44 7.5 18.75 7.5H5.25ZM10 16L15.5 12.5L10 9V16Z"/>
                        </svg>
                    </a>
                </div>
            </div>
