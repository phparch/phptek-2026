    ...
    <div class="container mx-auto px-6 py-4">
        <div class="flex items-center justify-between">
            ...
            <div class="hidden md:flex space-x-8 items-center">
                ...
                <!-- Theme toggle button -->
                <button @click="toggleTheme()" class="p-2 rounded-full bg-gray-100 dark:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-tek-blue-500" aria-label="Toggle dark mode">
