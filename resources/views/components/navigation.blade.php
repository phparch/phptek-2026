        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center">
                <a href="#" class="flex items-center">
                    <img src="https://cdn.phparch.social/phptek2026/logos/phptek_2026_logo.svg" alt="PHP Tek 2026 Logo" class="h-10 w-10 mr-3">
                    <span class="text-3xl font-display font-bold text-tek-blue-800 dark:text-tek-blue-400">PHPTek</span>
                    <span class="ml-1 bg-tek-orange-900 dark:bg-tek-orange-600 text-white text-sm font-bold py-1 px-2 rounded">2026</span>
                </a>
            </div>

            <div class="hidden md:flex space-x-8 items-center">
                <a href="#about" class="font-medium hover:text-tek-blue-700 dark:hover:text-tek-blue-400 transition-colors">About</a>
                <a href="#speakers" class="font-medium hover:text-tek-blue-700 dark:hover:text-tek-blue-400 transition-colors">Speakers</a>
                <a href="#schedule" class="font-medium hover:text-tek-blue-700 dark:hover:text-tek-blue-400 transition-colors">Schedule</a>
                <a href="#venue" class="font-medium hover:text-tek-blue-700 dark:hover:text-tek-blue-400 transition-colors">Venue</a>
            ...
            <div class="md:hidden" x-data="{ mobileMenu: false }">
                ...
                <div x-show="mobileMenu"
                    ...
                    <a href="#about" @click="mobileMenu = false" class="block font-medium hover:text-tek-blue-700 dark:hover:text-tek-blue-400 transition-colors">About</a>
                    <a href="#speakers" @click="mobileMenu = false" class="block font-medium hover:text-tek-blue-700 dark:hover:text-tek-blue-400 transition-colors">Speakers</a>
                    ...
                    <a href="#venue" @click="mobileMenu = false" class="block font-medium hover:text-tek-blue-700 dark:hover:text-tek-blue-400 transition-colors">Venue</a>
                    ...
                    <a href="#register" @click="mobileMenu = false" class="block bg-tek-orange-900 dark:bg-tek-orange-600 text-white px-5 py-2 rounded-lg text-center">Register Now</a>
