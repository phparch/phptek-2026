    ...
    >
        <div class="rounded-3xl border border-white/10 bg-black/40 p-10 shadow-2xl backdrop-blur">
            <div class="text-center">
                <div class="mx-auto flex h-20 w-20 items-center justify-center rounded-full bg-gradient-to-br from-orange-500 to-amber-400 text-4xl shadow-lg shadow-orange-500/30">
                    &#x1F511;
                </div>
                <p class="mt-6 text-xs font-semibold uppercase tracking-[0.4em] text-orange-300">PHP Tek 2026</p>
                <h1 class="mt-1 bg-gradient-to-r from-orange-300 via-amber-200 to-orange-400 bg-clip-text text-4xl font-black text-transparent">
                    Unlock the Drawing
                </h1>
                <p class="mt-2 text-sm text-orange-200/80">Enter the secret phrase to proceed.</p>
            </div>
            ...
            <form wire:submit="unlock" class="mt-8 space-y-4">
                <div>
                    ...
                    <input
                        ...
                        class="w-full rounded-2xl border border-white/15 bg-white/5 px-5 py-4 text-center text-2xl tracking-[0.4em] text-white placeholder:text-white/30 focus:border-orange-400 focus:bg-white/10 focus:outline-none focus:ring-2 focus:ring-orange-400/40"
                        @class([
                ...
                <button
                    ...
                    class="group relative w-full overflow-hidden rounded-2xl bg-gradient-to-r from-orange-500 to-amber-400 px-8 py-4 text-lg font-black uppercase tracking-widest text-white shadow-2xl shadow-orange-500/40 transition hover:scale-[1.02] hover:shadow-orange-500/60 disabled:cursor-not-allowed disabled:opacity-60 disabled:hover:scale-100"
                >
